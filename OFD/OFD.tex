...
{
\textbf{Installer VirtualBox :} {\sl \color{blue}sudo apt-get install virtualbox}\\
...
{\sl \color{blue}ike-scan <ip>}\vskip+0.2cm

\textit{Identification e la solution de VPN par fingerprinting.}\\
{\sl \color{blue}ike-scan --showbackoff -v -v <ip>}\vskip+0.2cm
...
{\sl \color{blue}ike-scan <ip>  {-}{-}auth=1}\vskip+0.2cm
...
\item IKEcrack : \url{http://sourceforge.net/projects/ikecrack/}\\ \url{http://ikecrack.sourceforge.net/}
