...
\begin{itemize}
	\item Génère une liste de mots de passe en parsant un site.
	\item Entrée : url
...
\begin{itemize}
	\item Génère une liste de mots à partir d'une autre en appliquant permutation, ajout de pre/suffixe, leet, lower/uppercase, acronyme etc.\\
...
\begin{itemize}
	\item Génère une liste de mots à partir de différents paramètre (longueur, type de char à inclure etc).
