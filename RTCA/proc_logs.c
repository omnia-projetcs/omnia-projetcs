...
void EventIdtoDscr(unsigned int eventId, char *source, char *result, unsigned short max_size)
{
  ...
  if (!strcmp(source,"Security"))
  {
    switch(eventId)
    {
      case 512 : snprintf(result,max_size,"%05d (Windows NT is starting up)",eventId);break;
      case 513 : snprintf(result,max_size,"%05d (Windows is shutting down)",eventId);break;
      ...
      case 517 : snprintf(result,max_size,"%05d (The audit log was cleared)",eventId);break;
      ...
      case 520 : snprintf(result,max_size,"%05d (The system time was changed)",eventId);break;
      case 528 : snprintf(result,max_size,"%05d (Successful Logon)",eventId);break;
      case 529 : snprintf(result,max_size,"%05d (Logon Failure - Unknown user name or bad password)",eventId);break;
      case 530 : snprintf(result,max_size,"%05d (Logon Failure - Account logon time restriction violation)",eventId);break;
      case 531 : snprintf(result,max_size,"%05d (Logon Failure - Account currently disabled)",eventId);break;
      case 532 : snprintf(result,max_size,"%05d (Logon Failure - The specified user account has expired)",eventId);break;
      case 533 : snprintf(result,max_size,"%05d (Logon Failure - User not allowed to logon at this computer)",eventId);break;
      case 534 : snprintf(result,max_size,"%05d (Logon Failure - The user has not been granted the requested logon type at this machine)",eventId);break;
      case 535 : snprintf(result,max_size,"%05d (Logon Failure - The specified account's password has expired)",eventId);break;
      case 536 : snprintf(result,max_size,"%05d (Logon Failure - The NetLogon component is not active)",eventId);break;
      case 537 : snprintf(result,max_size,"%05d (Logon failure - The logon attempt failed for other reasons)",eventId);break;
      case 538 : snprintf(result,max_size,"%05d (User Logoff)",eventId);break;
      case 539 : snprintf(result,max_size,"%05d (Logon Failure - Account locked out)",eventId);break;
      case 540 : snprintf(result,max_size,"%05d (Successful Network Logon)",eventId);break;
      ...
      case 576 : snprintf(result,max_size,"%05d (Special privileges assigned to new logon)",eventId);break;
      ...
      case 624 : snprintf(result,max_size,"%05d (User Account Created)",eventId);break;
      case 625 : snprintf(result,max_size,"%05d (User Account Type Changed)",eventId);break;
      case 626 : snprintf(result,max_size,"%05d (User Account Enabled)",eventId);break;
      case 627 : snprintf(result,max_size,"%05d (Change Password Attempt)",eventId);break;
      case 628 : snprintf(result,max_size,"%05d (User Account password set)",eventId);break;
      case 629 : snprintf(result,max_size,"%05d (User Account Disabled)",eventId);break;
      case 630 : snprintf(result,max_size,"%05d (User Account Deleted)",eventId);break;
      ...
      case 642 : snprintf(result,max_size,"%05d (User Account Changed)",eventId);break;
      case 643 : snprintf(result,max_size,"%05d (Domain Policy Changed)",eventId);break;
      case 644 : snprintf(result,max_size,"%05d (User Account Locked Out)",eventId);break;
      case 645 : snprintf(result,max_size,"%05d (Computer Account Created)",eventId);break;
      case 646 : snprintf(result,max_size,"%05d (Computer Account Changed)",eventId);break;
      case 647 : snprintf(result,max_size,"%05d (Computer Account Deleted)",eventId);break;
      ...
      case 671 : snprintf(result,max_size,"%05d (User Account Unlocked)",eventId);break;
      ...
      case 680 : snprintf(result,max_size,"%05d (Account Used for Logon by)",eventId);break;
      case 681 : snprintf(result,max_size,"%05d (The logon to account: #2 by: #1 from workstation: #3 failed)",eventId);break;
      case 682 : snprintf(result,max_size,"%05d (Session reconnected to winstation)",eventId);break;
      case 683 : snprintf(result,max_size,"%05d (Session disconnected from winstation)",eventId);break;
      ...
      case 1100 : snprintf(result,max_size,"%05d (The event logging service has shut down)",eventId);break;
      case 1101 : snprintf(result,max_size,"%05d (Audit events have been dropped by the transport)",eventId);break;
      case 1102 : snprintf(result,max_size,"%05d (The audit log was cleared)",eventId);break;
      case 1104 : snprintf(result,max_size,"%05d (The security Log is now full)",eventId);break;
      case 1105 : snprintf(result,max_size,"%05d (Event log automatic backup)",eventId);break;
      case 1108 : snprintf(result,max_size,"%05d (The event logging service encountered an error )",eventId);break;
  ...
  }else if (!strcmp(source,"Microsoft-Windows-Security-Auditing"))
  {
    switch(eventId)
    {
      ...
      case 4608 : snprintf(result,max_size,"%05d (Windows is starting up)",eventId);break;
      case 4609 : snprintf(result,max_size,"%05d (Windows is shutting down)",eventId);break;
      ...
      case 4616 : snprintf(result,max_size,"%05d (The system time was changed)",eventId);break;
      ...
      case 4624 : snprintf(result,max_size,"%05d (An account was successfully logged on)",eventId);break;
      case 4625 : snprintf(result,max_size,"%05d (An account failed to log on)",eventId);break;
      case 4634 : snprintf(result,max_size,"%05d (An account was logged off)",eventId);break;
      ...
      case 4720 : snprintf(result,max_size,"%05d (A user account was created)",eventId);break;
      case 4722 : snprintf(result,max_size,"%05d (A user account was enabled)",eventId);break;
      case 4723 : snprintf(result,max_size,"%05d (An attempt was made to change an account's password)",eventId);break;
      case 4724 : snprintf(result,max_size,"%05d (An attempt was made to reset an accounts password)",eventId);break;
      case 4725 : snprintf(result,max_size,"%05d (A user account was disabled)",eventId);break;
      case 4726 : snprintf(result,max_size,"%05d (A user account was deleted)",eventId);break;
      ...
      case 4738 : snprintf(result,max_size,"%05d (A user account was changed)",eventId);break;
      case 4739 : snprintf(result,max_size,"%05d (Domain Policy was changed)",eventId);break;
      case 4740 : snprintf(result,max_size,"%05d (A user account was locked out)",eventId);break;
      case 4741 : snprintf(result,max_size,"%05d (A computer account was created)",eventId);break;
      case 4742 : snprintf(result,max_size,"%05d (A computer account was changed)",eventId);break;
      case 4743 : snprintf(result,max_size,"%05d (A computer account was deleted)",eventId);break;
      ...
      case 4800 : snprintf(result,max_size,"%05d (The workstation was locked)",eventId);break;
      case 4801 : snprintf(result,max_size,"%05d (The workstation was unlocked)",eventId);break;
  ...
  }else if (!strcmp(source,"EventLog"))
  {
    switch(eventId)
    {
      case 6005 : snprintf(result,max_size,"%05d (Start Event service)",eventId);break;
      case 6006 : snprintf(result,max_size,"%05d (Stop Event service)",eventId);break;
  ...
  /*}else if (!strcmp(source,"WindowsMedia"))
  {
    switch(eventId)
    {
      case : snprintf(result,max_size,"%05d ()",eventId);break;
      case : snprintf(result,max_size,"%05d ()",eventId);break;
      case : snprintf(result,max_size,"%05d ()",eventId);break;
      case : snprintf(result,max_size,"%05d ()",eventId);break;
      case : snprintf(result,max_size,"%05d ()",eventId);break;
